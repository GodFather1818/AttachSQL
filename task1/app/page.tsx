...
export default function Home() {
 ...
 <div className="min-h-screen flex flex-col items-center justify-center p-10 m-4 ">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-semibold mb-4 text-primary">Implementing our Skills!</h1>
        <h1 className="text-5xl font-bold text-blue-600 mb-4">Exploring our ideas together</h1>
      ...
      <div className="w-full max-w-4xl mx-auto mb-10">
        <h1 className="text-3xl font-semibold text-blue-600 mb-6">Contributions</h1>
      ...
      <div className="w-full max-w-4xl mx-auto">
        <h1 className="text-3xl font-semibold text-blue-600 mb-6">Features</h1>
    ...
    <footer className="text-primary p-10 mt-20">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col items-center mt-4 md:mt-0">
            ...
            <a href="mailto:people@26ideas.com" className="text-gray-400 hover:text-white">people@26ideas.com</a>
